...
- (void)initTextView {
  _textView = [[UITextView alloc] initWithFrame:CGRectMake(20, 0, 280, 271)];
  [_textView setOpaque:NO];
  UIColor *bgColor = [[UIColor alloc] initWithRed:0.95 green:0.93 blue:0.83 alpha:1];
  [_textView setBackgroundColor:bgColor];
  ...
  _textView.font = [UIFont fontWithName:@"Helvetica" size:23];
